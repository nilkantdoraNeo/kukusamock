...
function parseQuestions(text) {
  ...
  for (const rawLine of lines) {
    ...
    if (trimmed === 'Surgery, Gynaecology & Obstetrics') {
      started = true;
      continue;
    }
    if (!started) continue;
...
function applyFixups(questions) {
  ...
  // Fix Q94 options from extracted table lines
